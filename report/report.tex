...
The Osborne one is a suitcase-sized portable computer released in 1981
...
which need to be copied using legacy hardware with usb drives, able to
be loaded with readily available files from the internet. The entire
project's source and documentation has been made readily available on
github(https://github.com/archiecarrot123/osborne-floppy-emulator) for
